package com.hanyang.demo.springbootsecurity.controller;

import com.google.code.kaptcha.impl.DefaultKaptcha;
import com.hanyang.demo.springbootsecurity.bean.User;
import com.hanyang.demo.springbootsecurity.security.SecuritySessionUtil;
import com.hanyang.demo.springbootsecurity.util.ConstantVal;
...
public class LoginController {
    ...
    public String userLogin(HttpServletRequest request) {
        ...
        try{
            ...
            User sessionData = SecuritySessionUtil.getSessionData();
            System.out.println(sessionData.getUsername());
            System.out.println(sessionData.getPassword());
            System.out.println(sessionData.getNickname());
        }catch (Exception e){
            e.printStackTrace();
